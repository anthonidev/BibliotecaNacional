                                            ...
                                            <div class="d-flex justify-content-between">
                                                <form action="../../ClienteControl" method="post" class="col-10">
                                                    <div class="row col-12">
                                                        <div class="col-9">
                                                            <input type="text" class="form-control" required placeholder="Buscar Cliente por DNI" name="dni" maxlength="8" onkeyup="this.value=Numeros(this.value)" aria-label="Recipient's username" aria-describedby="button-addon2">
                                                        </div>
