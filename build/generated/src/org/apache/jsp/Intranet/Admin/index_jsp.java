...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            <li class=\"nav-item mx-3\">\n");
      out.write("                                <ul class=\"navbar-nav me-auto mb-2 mb-lg-0 d-flex flex-column align-items-center align-items-lg-center justify-content-center justify-content-lg-end w-100\">   \n");
      out.write("                                    <li class=\"nav-item mx-3\">\n");
      out.write("                                        <h1 class=\"text-dark h5\"><i class=\"far fa-address-card\"></i> codigo:  </h1>\n");
      out.write("                                    </li>\n");
      out.write("                                    <li class=\"nav-item mx-3\">\n");
      out.write("                                        <h1 class=\"text-dark h5\"><i class=\"fas fa-user\"></i> Nombre:  </h1>\n");
      out.write("                                    </li>\n");
      out.write("\n");
      out.write("                                </ul>\n");
      out.write("                            </li>\n");
      ...
      out.write("                                    <input type=\"submit\" name=\"acc\" class=\"btn-danger btn  w-100 \" value=\"Cerrar\">\n");
      out.write("                                </form>\n");
      out.write("                            </li>\n");
      out.write("\n");
      out.write("                        </ul>\n");
      ...
      out.write("                        <li class=\"nav-item my-4 shadow-sm p-3 my-3 bg-body rounded \">\n");
      out.write("                            <form action=\"\">\n");
      out.write("                                <input class=\"nav-link active text-dark h5 text-center border-0 bg-body m-auto\" type=\"submit\" name=\"acc\" value=\"Libros\" >\n");
      out.write("                                <i class=\"fas fa-book-open w-100 text-center h5\"></i>\n");
      out.write("\n");
      out.write("                            </form>\n");
      out.write("                        </li>\n");
      out.write("                        <li class=\"nav-item my-4 shadow-sm p-3 my-3 bg-body rounded \">\n");
