<%-- 
    Document   : Login
    Created on : 03/06/2021, 10:43:42 PM
    Author     : Anthoni
--%>
            ...
            <div class="row">
                <div class="col-12 col-md-9 m-auto mt-5">
                    <div class="card mb-md-3 shadow p-3 mb-5 bg-body rounded  ">
                        <div class="row g-0">
                            <div class="col-md-6 ">
                                <img class="img-fluid" src="https://image.freepik.com/vector-gratis/ilustracion-plana-dia-mundial-libro_23-2148890538.jpg" alt="...">
                            </div>
