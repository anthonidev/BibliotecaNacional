...
<html>
    ...
    <body>
        <main class="container-fluid p-0  ">
                    ...
                    <ul class="navbar-nav d-flex justify-content-between me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item shadow-sm p-3 bg-danger rounded">
                            <form action="../../BoletaControl" method="post">
                                ...
                                <input class="nav-link active text-dark text-center border-0 bg-danger m-auto p-2" type="submit" name="acc" value="Boletas" >
                            </form>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="col-12 my-4">
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="col-6 mt-3" id="mostrar">
                                            ...
                                            <a href="#listar" class="btn btn-secondary my-2 py-3 fw-bold">Listar Pedidos</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="d-flex">
                <div class="col-5 m-auto d-flex w-50 justify-content-center align-items-center flex-column" style="height: 100vh" id="listar">
